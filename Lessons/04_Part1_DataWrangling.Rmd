...
NTL.phys.data$lakeid <- as.character(NTL.phys.data$lakeid)
...
#this is also selecting everything between sampledate and temperature_c including those two extremes. 

...
NTL.nutrient.data.PeterPaul$sampledate <-ymd(NTL.nutrient.data.PeterPaul$sampledate)
  
 # as.Date(NTL.nutrient.data.PeterPaul$sampledate, format = "%y/%m/%d")
...
write.csv(LitterTrap, row.names = FALSE, file=here("Data/Processed/NEON_NIWO_Litter_mass_trap_Processed.csv"))
```

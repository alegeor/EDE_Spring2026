...
```{r exercise for creating variable in class}
vector5 <- c(37,25,19,25,12,19,17,11,13,17)
mean_temp <- mean(vector5)
summary_stats <-summary(vector5)
```
...
#Create another vector of the values 10 thru 15. c is the command to create a vector collection.
vector4 <- c(10:15)
...
# ! is coding shorthand for not. it will invert what comes after it. 
!vector3
...
matrix1[4, 1] # commans means 4th and 1st

matrix1[4,  ] # this means I want everything in Y

matrix1[ , 3] # everything in X

matrix1[c(12, 14)] # comma means 12th and 14th

matrix1[c(12:14)] # colon means 12th through 14th

matrix1[2:4, 1:3] #all data in rows 2-4, columns 1-3
...
#below we can fetch columns according to their names 
...
# I should not be getting an error code here?  Chat w/ John after class. 
```

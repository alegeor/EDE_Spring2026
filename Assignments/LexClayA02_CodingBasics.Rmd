...
if (y==54){
  print("You failed but 54 is my lucky number so I will let you retest!")
}else if (y>50){
    print("You passed this time!")
}
```
...
#run with ifelse
if(testscores == 54){
  print("Even geniuses fail. Try again!")
...
```{R}
dogsagehumanyears <-6
dogsagedogyears <- dogsagehumanyears * 7

if (dogsagehumanyears > 7){
  print("Why must I age in increments of 7? Not fair.")
}else if (dogsagehumanyears < 7){
print("puppy life")
}
```
...
```{R}
ancientdog <-54
dogsagedogyears <- ancientdog * 7

if (ancientdog > 7){
  print("I am the most ancient dog. ")
}else if (ancientdog < 7){
print("puppy life")
}
```

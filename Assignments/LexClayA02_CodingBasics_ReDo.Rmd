...
```{R}
test1_grade <- test1_score(54) #prints output automatically 

test2_grade <- test2_score(54) #output in console 
...
# test1_score(testscores) this returns the error: Error in if (testscores > 50) { : the condition has length > 1

test2_score(testscores) #this returns "pass" four times
```
...
myage <- function(x){
if (x < 30){
print("This is the decade of the existential crisis.")
}else if (x >=30 & x < 40){
print("30s is the new 20s!")
}else{
print("Old? Age is just a numeric variable!")
}
}
...
siblingstatus <- function(x){
  ifelse(x>12, "Teenager","Child")
}

youngestage <- siblingstatus(3)

...
EPAAirList <- list(
  ...
  EPAAirTwo <-read.csv(file=here('./Data/Raw/EPAair_O3_NC2019_raw.csv')),
  EPAAirThree <- read.csv(file=here('./Data/Raw/EPAair_PM25_NC2018_raw.csv')),
  EPAAirFour <- read.csv(file=here('./Data/Raw/EPAair_PM25_NC2019_raw.csv'))
)

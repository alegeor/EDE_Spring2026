...
fancy.scraper <- function(Year, pwsid){
 ...
 # fancy.report.url <- paste0(stripped.report.url, pwsid,"&year=",Year) #tried to run this first but it triggered error msg. 
  ...
  fancy.report.url <- read_html(paste0("https://www.ncwater.org/WUDC/app/LWSP/report.php?pwsid=", pwsid,"&year=",Year))
...
> Answer:
> It is visually subtle, but the max water usage increases around 2021, peaks between 2022-2023, and then returns to pre-2021 levels. 